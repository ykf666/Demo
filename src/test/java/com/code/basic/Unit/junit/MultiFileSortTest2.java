...
import com.code.algorithm.MultiFileSort2;
 ...
 */
public class MultiFileSortTest2 {

    private final static String[] SMALL_FILES = new String[]{"D:\\subFile_3", "D:\\subFile_4", "D:\\subFile_5"};

    private final static String MAIN_FILE_PATH = "D:\\mainFile2";
    ...
    public void before() {
        ...
        for (String filePath : SMALL_FILES) {
            ...
            //写入子文件
            for (long val : arr) {
                MultiFileSort2.write(val, filePath);
            }
    ...
    public void testSort() {
        ...
        MultiFileSort2.sort(SMALL_FILES, MAIN_FILE_PATH);
        Long[] actual = MultiFileSort2.load(MAIN_FILE_PATH);
